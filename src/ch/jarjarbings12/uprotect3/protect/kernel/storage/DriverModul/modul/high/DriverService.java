package ch.jarjarbings12.uprotect3.protect.kernel.storage.DriverModul.modul.high;

import ch.jarjarbings12.uprotect3.protect.kernel.storage.DriverModul.modul.exceptions.InvalidClassPathException;
...
import ch.jarjarbings12.uprotect3.protect.kernel.storage.DriverModul.modul.low.ModuleClassLoader;
import ch.jarjarbings12.uprotect3.protect.kernel.storage.DriverModul.modul.low.properties.DescriptionParser;
import ch.jarjarbings12.uprotect3.protect.kernel.storage.DriverModul.modul.low.properties.PropertyLoader;
...
public class DriverService
{
    ...
    private ModuleClassLoader moduleClassLoader = new ModuleClassLoader();
    ...
    public void init()
    {
        ...
        for (File f : files)
        {
            try
            {
                ...
                if (!moduleClassLoader.existClassPath(f, fileDriverDescription.get(f.getName()).getDriverDescription().getClassPath()))
                {
    ...
    {
        return (UDriver) moduleClassLoader.loadModule(filePath, classPath);
    }
}
